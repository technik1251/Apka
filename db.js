...
// ==========================================
let defaultDb = {
    init: false, mainProfile: null, role: null, tab: 'term', filter: 'today', filterFrom: null, filterTo: null, userName: '',
    drv: { 
    ...
    home: { 
        n: 'Dom', sal: 0, fix: 0, 
        accs: [{id:'bank', n:'Konto Bankowe', c:'#3b82f6', i:'🏦', startBal:0}, {id:'cash', n:'Portfel', c:'#10b981', i:'💵', startBal:0}, {id:'card', n:'Karta Kredytowa', c:'#f59e0b', i:'💳', startBal:0}],
